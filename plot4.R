...
par(mfrow = c(2,2))
with(hpc_subset, {
 plot(hpc_subset$Date, hpc_subset$Global_active_power, xlab = '', ylab = 'Global Active Power', type = 'l') 
  plot(hpc_subset$Date, hpc_subset$Voltage, xlab = 'datetime', ylab = 'Voltage', type = 'l')
  plot(hpc_subset$Date, hpc_subset$Sub_metering_1, xlab = '', ylab = 'Energy sub metering', type = 'l')
...
legend('topright', lty = 1, bty = 'n', col = c('black','red','blue'), legend = c('Sub_metering_1','Sub_metering_2','Sub_metering_3'))
  plot(hpc_subset$Date, hpc_subset$Global_reactive_power, xlab = 'datetime', ylab = 'Global_reactive_power', type = 'l')
})
dev.off()
